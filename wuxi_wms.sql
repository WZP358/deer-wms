...
-- ----------------------------
-- Table structure for bill_in_receive
-- ----------------------------
DROP TABLE IF EXISTS `bill_in_receive`;
CREATE TABLE `bill_in_receive` (
  `bill_in_receive_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '入库接收统计',
  `bill_in_detail_id` int(11) DEFAULT NULL COMMENT '订单Id',
  `receive_quantity` int(11) DEFAULT NULL COMMENT '此订单接收数量总和',
  `box_code` varchar(255) DEFAULT NULL COMMENT '箱号',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `pd` datetime DEFAULT NULL COMMENT '生产日期',
  `exp` datetime DEFAULT NULL COMMENT '失效日期',
  `batch` varchar(255) DEFAULT NULL COMMENT '批次',
  `receipt_num` varchar(255) DEFAULT NULL COMMENT '接收单号',
  `operator_no` varchar(255) DEFAULT NULL COMMENT '接收人',
  ...
  `po_distribution_id` int(11) DEFAULT NULL,
  `item_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`bill_in_receive_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of bill_in_receive
-- ----------------------------
INSERT INTO `bill_in_receive` VALUES ('2', '134', '246', 'FTB0039', '2020-09-18 17:49:50', '2020-09-11 00:00:00', '2022-09-11 00:00:00', 'IJG11705', '9317', '4057586412', '2', '1149422', '4867686', '6285976', '5894938', '1341902');
INSERT INTO `bill_in_receive` VALUES ('3', '134', '214', 'FTB0004', '2020-09-18 17:57:59', '2020-09-11 00:00:00', '2022-09-11 00:00:00', 'IJG17105', '9321', '4057586412', '2', '1149422', '4867686', '6285976', '5894938', '1341902');
INSERT INTO `bill_in_receive` VALUES ('4', '134', '540', 'FTB0017', '2020-09-19 16:47:12', '2020-09-11 00:00:00', '2022-09-11 00:00:00', 'IJG17105', '9351', '4057586412', '2', '1149422', '4867686', '6285976', '5894938', '1341902');
INSERT INTO `bill_in_receive` VALUES ('5', '134', '570', 'FTB0018', '2020-09-20 08:29:53', '2020-09-11 00:00:00', '2022-09-11 00:00:00', 'IJG11705', '9357', '4057586412', '2', '1149422', '4867686', '6285976', '5894938', '1341902');
INSERT INTO `bill_in_receive` VALUES ('6', '134', '450', 'FTB0072', '2020-09-20 08:54:58', '2020-09-11 00:00:00', '2022-09-11 00:00:00', 'IJG11705', '9361', '4057586412', '2', '1149422', '4867686', '6285976', '5894938', '1341902');
INSERT INTO `bill_in_receive` VALUES ('7', '134', '480', 'FTB0062', '2020-09-20 09:15:18', '2020-09-11 00:00:00', '2022-09-11 00:00:00', 'IJG11705', '9362', '4057586412', '2', '1149422', '4867686', '6285976', '5894938', '1341902');
INSERT INTO `bill_in_receive` VALUES ('8', '135', '100', 'FTB0033', '2020-09-20 09:42:51', '2020-09-08 00:00:00', '2021-09-07 00:00:00', 'K0I-204-036', '9363', '4057586412', '2', '1150723', '4874862', '6297918', '5901221', '1819412');
INSERT INTO `bill_in_receive` VALUES ('9', '136', '100', 'FTB0003', '2020-09-20 10:04:23', '2020-09-08 00:00:00', '2021-09-07 00:00:00', 'K0I-303-029', '9364', '4057586412', '2', '1150561', '4872375', '6296025', '5899692', '1819412');
INSERT INTO `bill_in_receive` VALUES ('10', '149', '23', 'FTB0058', '2020-09-30 14:25:48', '2020-09-23 00:00:00', '2022-09-23 00:00:00', 'IJG27305', '9656', '4057586412', '2', '1152273', '4882872', '6316001', '5911203', '1341892');
INSERT INTO `bill_in_receive` VALUES ('11', '149', '477', 'FTB0041', '2020-09-30 14:55:38', '2020-09-23 00:00:00', '2022-09-23 00:00:00', 'IJI02308', '9657', '4057586412', '2', '1152273', '4882872', '6316001', '5911203', '1341892');
...
CREATE TABLE `bill_out_detail` (
  ...
  `already_out_quantity` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for delay_worker_order
-- ----------------------------
DROP TABLE IF EXISTS `delay_worker_order`;
CREATE TABLE `delay_worker_order` (
  `delay_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '延期库存工单',
  `worker_order_id` varchar(255) DEFAULT NULL COMMENT '工单Id',
  `item_code` varchar(255) DEFAULT NULL COMMENT '料号',
  `batch` varchar(255) DEFAULT NULL COMMENT '批次',
  `exp` date DEFAULT NULL COMMENT '延期日期',
  `operator_no` varchar(255) DEFAULT NULL COMMENT '操作人',
  PRIMARY KEY (`delay_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of delay_worker_order
-- ----------------------------
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'LAPTOP-CQEGTP4S1665899128182', '1665899862513', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1665899130000', '-1', '5', 'PAUSED', 'CRON', '1665899129000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1665899140000', '-1', '5', 'PAUSED', 'CRON', '1665899130000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', null, '1665901800000', '-1', '5', 'PAUSED', 'CRON', '1665899130000', '0', null, '-1', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME4', 'DEFAULT', 'TASK_CLASS_NAME4', 'DEFAULT', null, '1665903600000', '-1', '5', 'PAUSED', 'CRON', '1665899131000', '0', null, '-1', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME5', 'DEFAULT', 'TASK_CLASS_NAME5', 'DEFAULT', null, '1665940200000', '-1', '5', 'PAUSED', 'CRON', '1665899132000', '0', null, '2', '');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('93c2626a-7347-4a35-ab01-cc25a9882cbf', 'wxy', '研发部门', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', 'on_line', '2022-10-16 13:41:06', '2022-10-16 13:46:59', '259200000');
...
-- ----------------------------
-- Table structure for warn_alram
-- ----------------------------
DROP TABLE IF EXISTS `warn_alram`;
CREATE TABLE `warn_alram` (
  `location` varchar(333) DEFAULT NULL COMMENT '报警位置',
  `code` varchar(333) DEFAULT NULL COMMENT '编码',
  `state` int(11) DEFAULT NULL COMMENT '报警状态',
  `content` varchar(333) DEFAULT NULL COMMENT '报警内容',
  `process_method` varchar(333) DEFAULT NULL COMMENT '处理方法'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of warn_alram
-- ----------------------------
INSERT INTO `warn_alram` VALUES ('M116', 'M116_ConveyanceRun', '1', 'M116输送运行超时ERROR_M22.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M117', 'M117_ConveyanceRun', '1', 'M117输送运行超时ERROR_M22.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M118', 'M118_ConveyanceRun', '1', 'M118输送运行超时ERROR_M22.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M118', 'M118_TransplantRun', '1', 'M118移载运行超时ERROR_M22.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M119', 'M119_ConveyanceRun', '1', 'M119输送运行超时ERROR_M22.4', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M122', 'M122_ConveyanceRun', '1', 'M122输送运行超时ERROR_M22.5', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M121', 'M121_ConveyanceRun', '1', 'M121输送运行超时ERROR_M22.6', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M123', 'M123_ConveyanceRun', '1', 'M123输送运行超时ERROR_M23.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M124', 'M124_WhirlRun', '1', 'M124旋转运行超时ERROR_M23.5', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M124', 'M124_ConveyanceRun', '1', 'M124输送运行超时ERROR_M23.7', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M125', 'M125_ConveyanceRun', '1', 'M125输送运行超时ERROR_M24.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M126', 'M126_ConveyanceRun', '1', 'M126输送运行超时ERROR_M24.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M127', 'M127_ConveyanceRun', '1', 'M127输送运行超时ERROR_M24.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M127', 'M127_TransplantRun', '1', 'M127移载运行超时ERROR_M24.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M129', 'M129_ConveyanceRun', '1', 'M129输送运行超时ERROR_M24.4', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M130', 'M130_ConveyanceRun', '1', 'M130输送运行超时ERROR_M24.6', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M130', 'M130_TransplantRun', '1', 'M130移载运行超时ERROR_M25.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M131', 'M131_WhirlRun', '1', 'M131旋转运行超时ERROR_M25.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M131', 'M131_ConveyanceRun', '1', 'M131输送运行超时ERROR_M25.4', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M132', 'M132_ConveyanceRun', '1', 'M132输送运行超时ERROR_M25.5', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M133', 'M133_ConveyanceRun', '1', 'M133输送运行超时ERROR_M23.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M134', 'M134_ConveyanceRun', '1', 'M134输送运行超时ERROR_M22.7', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M116', 'M116_ConveyanceElectricMotor', '1', 'M116输送电机过载热保护_i10.0', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M117', 'M117_ConveyanceElectricMotor', '1', 'M117输送电机过载热保护_i10.1', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M118', 'M118_ConveyanceElectricMotor', '1', 'M118输送电机过载热保护_i10.2', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M118', 'M118_TransplantElectricMotor', '1', 'M118移载电机过载热保护_i10.3', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M119', 'M119_ConveyanceElectricMotor', '1', 'M119输送电机过载热保护_i10.4', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M122', 'M122_ConveyanceElectricMotor', '1', 'M122输送电机过载热保护_i10.5', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M121', 'M121_ConveyanceElectricMotor', '1', 'M121输送电机过载热保护_i10.6', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M133', 'M133_ConveyanceElectricMotor', '1', 'M133输送电机过载热保护_i10.7', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M134', 'M134_ConveyanceElectricMotor', '1', 'M134输送电机过载热保护_i11.0', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M123', 'M123_ConveyanceElectricMotor', '1', 'M123输送电机过载热保护_i11.1', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M124', 'M124_WhirlElectricMotor', '1', 'M124旋转电机过载热保护_i11.2', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M124', 'M124_ConveyanceElectricMotor', '1', 'M124输送电机过载热保护_i11.3', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M125', 'M125_ConveyanceElectricMotor', '1', 'M125输送电机过载热保护_i11.4', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M126', 'M126_ConveyanceElectricMotor', '1', 'M126输送电机过载热保护_i11.5', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M127', 'M127_ConveyanceElectricMotor', '1', 'M127输送电机过载热保护_i11.6', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M127', 'M127_TransplantElectricMotor', '1', 'M127移载电机过载热保护_i11.7', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M129', 'M129_ConveyanceElectricMotor', '1', 'M129输送电机过载热保护_i12.0', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M130', 'M130_ConveyanceElectricMotor', '1', 'M130输送电机过载热保护_i12.1', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M130', 'M130_TransplantElectricMotor', '1', 'M130移载电机过载热保护_i12.2', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M131', 'M131_WhirlElectricMotor', '1', 'M131旋转电机过载热保护_i12.3', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M131', 'M131_ConveyanceElectricMotor', '1', 'M131输送电机过载热保护_i12.4', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M132', 'M132_ConveyanceElectricMotor', '1', 'M132输送电机过载热保护_i12.5', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M119', 'M119_QuickStopControl', '0', 'M119急停按钮_i1.5', '急停中');
INSERT INTO `warn_alram` VALUES ('M101', 'M101_PromoteElectricMotor', '1', 'M101提升电机过载热保护_i11.7', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M101', 'M101_ConveyanceElectricMotor', '1', 'M101输送电机过载热保护_i9.2', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M102', 'M102_ConveyanceElectricMotor', '1', 'M102输送电机过载热保护_i9.1', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M103', 'M103_ConveyanceElectricMotor', '1', 'M103输送电机过载热保护_i9.0', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M103', 'M103_WhirlElectricMotor', '1', 'M103旋转电机过载热保护_i9.3', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M105', 'M105_ConveyanceElectricMotor', '1', 'M105输送电机过载热保护_i9.4', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M106', 'M106_ConveyanceElectricMotor', '1', 'M106输送电机过载热保护_i9.5', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M107', 'M107_ConveyanceElectricMotor', '1', 'M107输送电机过载热保护_i9.6', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M108', 'M108_ConveyanceElectricMotor', '1', 'M108输送电机过载热保护_i11.6', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M109', 'M109_TransplantElectricMotor', '1', 'M109移载电机过载热保护_i11.5', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M109', 'M109_ConveyanceElectricMotor', '1', 'M109输送电机过载热保护_i11.4', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M110', 'M110_ConveyanceElectricMotor', '1', 'M110输送电机过载热保护_i11.3', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M111', 'M111_ConveyanceElectricMotor', '1', 'M111输送电机过载热保护_i11.2', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M112', 'M112_ConveyanceElectricMotor', '1', 'M112输送电机过载热保护_i11.1', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M113', 'M113_ConveyanceElectricMotor', '1', 'M113输送电机过载热保护_i11.0', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M101', 'M101_QuickStopControl', '0', 'M101急停按钮_i12.1', '急停中');
INSERT INTO `warn_alram` VALUES ('M105', 'M105_QuickStopControl', '0', 'M105急停按钮_i13.4', '急停中');
INSERT INTO `warn_alram` VALUES ('M101', 'M101_ConveyanceRun', '1', 'M101输送运行超时ERROR_M50.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M101', 'M101_PromoteRun', '1', 'M101提升运行超时ERROR_M50.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M102', 'M102_ConveyanceRun', '1', 'M102输送运行超时ERROR_M50.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M103', 'M103_ConveyanceRun', '1', 'M103输送运行超时ERROR_M50.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M103', 'M103_WhirlRun', '1', 'M103旋转运行超时ERROR_M50.4', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M105', 'M105_ConveyanceRun', '1', 'M105输送运行超时ERROR_M50.5', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M106', 'M106_ConveyanceRun', '1', 'M106输送运行超时ERROR_M50.6', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M107', 'M107_ConveyanceRun', '1', 'M107输送运行超时ERROR_M50.7', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M108', 'M108_ConveyanceRun', '1', 'M108输送运行超时ERROR_M51.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M109', 'M109_ConveyanceRun', '1', 'M109输送运行超时ERROR_M51.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M109', 'M109_TransplantRun', '1', 'M109移载运行超时ERROR_M51.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M110', 'M110_ConveyanceRun', '1', 'M110输送运行超时ERROR_M51.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M111', 'M111_ConveyanceRun', '1', 'M111输送运行超时ERROR_M51.4', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M112', 'M112_ConveyanceRun', '1', 'M112输送运行超时ERROR_M51.5', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M113', 'M113_ConveyanceRun', '1', 'M113输送运行超时ERROR_M51.6', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M107', 'M107_TransplantRun', '1', 'M107移载运行超时ERROR_M51.7', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M107', 'M107_TransplantElectricMotor', '1', 'M107移载电机过载热保护_i9.7', '硬件保护中');
INSERT INTO `warn_alram` VALUES ('M107', 'M107_UpAndDownCylinder', '1', 'M107上下气缸运行超时ERROR_M52.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M109', 'M109_UpAndDownCylinder', '1', 'M109上下气缸运行超时ERROR_M52.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M110', 'M110_SideCylinder', '1', 'M110侧推气缸运行超时ERROR_M52.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M110', 'M110_CheckCylinder', '1', 'M110检测气缸运行超时ERROR_M52.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M113', 'M113_SideCylinder', '1', 'M113侧推气缸运行超时ERROR_M52.4', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M113', 'M113_CheckCylinder', '1', 'M113检测气缸运行超时ERROR_M52.5', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M135', 'Osculum', '1', 'M114吸盘检测无ERROR_M52.7', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M117', 'M117_SideCylinder', '1', 'M117侧推气缸运行超时ERROR_M26.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M118', 'M118_PromoteCylinder', '1', 'M118提升气缸运行超时ERROR_M26.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M121', 'M121_SideCylinder', '1', 'M121侧推气缸运行超时ERROR_M26.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M121', 'M121_CheckCylinder', '1', 'M121检测气缸运行超时ERROR_M26.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M123', 'M123_PromoteCylinder', '1', 'M123提升气缸运行超时ERROR_M26.4', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M124', 'M124_UpAndDownCylinder', '1', 'M124上下气缸运行超时ERROR_M26.5', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M127', 'M127_PromoteCylinder', '1', 'M127提升气缸运行超时ERROR_M26.6', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M130', 'M130_PromoteCylinder', '1', 'M130提升气缸运行超时ERROR_M26.7', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M131', 'M131_UpAndDownCylinder', '1', 'M131上下气缸运行超时ERROR_M27.0', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M131', 'M131_SideCylinder', '1', 'M131侧推X2气缸运行超时ERROR_M27.1', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M132', 'M132_PromoteCylinder', '1', 'M132提升气缸运行超时ERROR_M27.2', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M133', 'M133_SideCylinder', '1', 'M133侧推气缸运行超时ERROR_M27.3', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M135', 'M135_Osculum', '1', 'M135吸盘异常ERROR_M27.7', '请先找原因，再去电控柜上进行复位或程序复位');
INSERT INTO `warn_alram` VALUES ('M113', 'InWare_InAlarm', '1', 'M113入库口入空箱检测有货DB1.W76', '请停止自动运行后，再去框中取出覆铜板');
INSERT INTO `warn_alram` VALUES ('M113', 'InWare_InAlarm', '2', 'M113入库口入有货箱检测无货DB1.W76', '请盘点');
INSERT INTO `warn_alram` VALUES ('M110', 'InWare_OutAlarm', '1', 'M110入库口出空箱检测有货DB1.W78', '请盘点');
INSERT INTO `warn_alram` VALUES ('M110', 'InWare_OutAlarm', '2', 'M110入库口出有货箱检测无货DB1.W78', '请盘点');
INSERT INTO `warn_alram` VALUES ('M121', 'OutWare_InAlarm', '1', 'M121出库段入空箱检测有货VW50', '请盘点');
INSERT INTO `warn_alram` VALUES ('M121', 'OutWare_InAlarm', '2', 'M121出库段入有货箱检测无货VW50', '请盘点');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '1', '远程急停', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '2', '本地急停', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '3', '行走变频器故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '4', '提升变频器故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '5', '货叉变频器故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '6', '前极限', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '7', '后极限', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '8', '上极限', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '9', '下极限', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '10', '货叉左极限', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '11', '货叉右极限', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '12', '前超差', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '13', '后超差', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '14', '左超差', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '15', '右超差', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '16', '高超差', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '17', '左放货货架有货', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '18', '右放货货架有货', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '19', '放货时载货台无货', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '20', '取货完成后载货台无货', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '21', '放货完成后载货台有货', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '22', '取货时货叉上有货', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '23', '载货台货物位置出现偏差', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '24', '提升扫码测距读值出错', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '25', '行走激光测距读值出错', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '26', '货叉编码器读值出错', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '27', '货叉运行超时', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '28', '提升运行超时', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '29', '行走运行超时', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '30', '货叉电机堵转', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '31', '行走电机堵转', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '32', '提升电机堵转', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '33', '排列层给定超限', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '34', '货叉动作时列不在列认址位置', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '35', '货叉动作时列不在层认址位置', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '36', '行走提升时货叉不在中位', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '37', '货叉动作时不在层列位置', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '38', '升降方向错误', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '39', '行走方向错误', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '40', '货叉方向错误', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '41', '输送线和堆垛机站点交互错误', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '42', '认址和速度计算出错', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '43', '接收排列层出错', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '44', '取货动作不在指定的列层位置', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '45', '卸货动作不在指定的列层位置', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '46', '堆垛机和输送线通讯中断', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '48', '松绳故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '52', 'IO设备故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '53', '水平激光测距通讯故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '54', '升降扫码器通讯故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '55', '提升变频器通讯故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '56', '行走变频器通讯故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '57', '货叉编码器通讯故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '58', '货叉变频器通讯故障', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('堆垛机', 'Alarm_Code', '59', '与上位机通讯超时', '请先找原因，再去工控机上手动复位，或者操作堆垛机程序手动复位');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1000', 'F1000 紧急停止按钮被按下', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1001', 'F1001 总气源压力不足', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1002', 'F1002 PLC 电池不足', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1003', 'F1003 机器安全光栅触发', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1004', 'F1004 机器安全门被打开', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1005', 'F1005 放、收板机通讯异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1006', 'F1006 MES通讯异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1007', 'F1007 电箱温度过高', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1008', 'F1008 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1009', 'F1009 后面机器没有准备好', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1010', 'F1010 顶部传送伺服NC模块故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1011', 'F1011 顶部传送伺服驱动器故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1012', 'F1012 PCB提取臂伺服NC模块故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1013', 'F1013 PCB提取臂伺服驱动器故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1014', 'F1014 Z轴伺服NC模块故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1015', 'F1015 Z轴伺服驱动器故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1016', 'F1016 PCB吸盘真空异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1017', 'F1017 PCB吸盘掉板异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1018', 'F1018 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1019', 'F1019 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1020', 'F1020 左侧盒子升/降气缸异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1021', 'F1021 右侧盒子升/降气缸异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1022', 'F1022 左侧盒子锁定气缸异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1023', 'F1023 右侧盒子锁定气缸异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1024', 'F1024 PCB吸盘真空异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1025', 'F1025 PCB吸盘掉板异常', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1026', 'F1026 左侧输送带超时报警', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1027', 'F1027 右侧输送带超时报警', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1028', 'F1028 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1029', 'F1029 出库模式点数任务数量不足', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1030', 'F1030 左侧盒子空报警', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1031', 'F1031 右侧盒子满报警', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1032', 'F1032 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1033', 'F1033 叠板检测气缸或者电磁阀故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1034', 'F1034 吸盘出现叠板故障', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1035', 'F1035 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1036', 'F1036 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1037', 'F1037 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1038', 'F1038 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1039', 'F1039 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1040', 'F1040 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1041', 'F1041 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1042', 'F1042 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1043', 'F1043 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1044', 'F1044 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1045', 'F1045 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1046', 'F1046 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1047', 'F1047 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1048', 'F1048 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1049', 'F1049 备用', '请至分批机处手动处理');
INSERT INTO `warn_alram` VALUES ('分批机', 'Count_Device_Alarm', '1050', 'F1050 备用', '请至分批机处手动处理');
...
CREATE TABLE `worker_order_issue_time` (
  ...
  `delay_control` int(2) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
DROP VIEW IF EXISTS `库存`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `库存` AS select `item_info`.`item_code` AS `料号`,`box_item`.`box_code` AS `框号`,`cell_info`.`shelf_id` AS `货架`,`cell_info`.`s_column` AS `列`,`cell_info`.`s_row` AS `层`,`box_item`.`batch` AS `批次`,`box_item`.`quantity` AS `数量`,`box_item`.`pd` AS `生产日期`,`box_item`.`exp` AS `过期日期`,`box_item`.`in_time` AS `入库时间`,`box_item`.`sub_inventory_id` AS `子库` from (((`item_info` join `box_item` on((`item_info`.`item_code` = `box_item`.`item_code`))) join `box_info` on((`box_item`.`box_code` = `box_info`.`box_code`))) join `cell_info` on((`box_info`.`box_cell_id` = `cell_info`.`cell_id`))) ;
