...
public class CombineBoxRecordServiceImpl extends AbstractService<CombineBoxRecord, Integer> implements CombineBoxRecordService {
    ...
    @Override
    public List<CombineBoxRecordDto> findList(CombineBoxRecordCriteria combineBoxRecordCriteria){
        return combineBoxRecordMapper.findList(combineBoxRecordCriteria);
    }
