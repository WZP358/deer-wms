...
public class BillInRecordCriteria extends QueryCriteria {
    ...
    public BillInRecordCriteria(String receiptNum,Integer state) {
        this.receiptNum = receiptNum;
        this.state = state;
    }
    ...
    public BillInRecordCriteria(Integer orderParam, Integer poHeaderId, Integer poLineId, Integer lineLocationId, Integer poDistributionId, String batch, Integer itemId,Integer quantity) {
        this.orderParam = orderParam;
        this.poHeaderId = poHeaderId;
        this.poLineId = poLineId;
        this.lineLocationId = lineLocationId;
    ...
    public BillInRecordCriteria(Integer state) {
        this.state = state;
    }
}
