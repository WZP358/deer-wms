...
public class SubinventoryTransferRecordCriteria extends QueryCriteria {
    ...
    private String delayWorkerOrderId;
    ...
    public String getDelayWorkerOrderId() {
        return delayWorkerOrderId;
    }

    public void setDelayWorkerOrderId(String delayWorkerOrderId) {
        this.delayWorkerOrderId = delayWorkerOrderId;
    }
